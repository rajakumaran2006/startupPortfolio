...
export default function OptionWheel({
  ...
  }, [items, fontSize, spacing, curve, tilt, blur, fade, minOpacity, side, loop, smoothing, draggable, soundUrl, soundVolume, onChange, remPx]);
  ...
  // Audio tick fallback with Web Audio API synthesizer for instant zero-latency feedback if soundUrl is empty
  const playTick = useCallback(() => {
    ...
    if (soundUrl) {
      ...
      try {
        ...
        gain.gain.setValueAtTime(0.08 * soundVolume, ctx.currentTime);
  ...
  return (
    <div
      ...
      role="listbox"
      tabIndex={0}
      aria-label="Risk mode selector wheel"
