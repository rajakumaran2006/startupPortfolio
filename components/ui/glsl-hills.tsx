...
const GLSLHills: React.FC<GLSLHillsProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      geometry = new THREE.PlaneGeometry(planeSize, planeSize, planeSize, planeSize);
      ...
      console.warn('GLSLHills WebGL initialization fallback:', err);
    }
  }, [cameraZ, planeSize, speed, wireframe]);
